...
new class extends Component {
    ...
    public string $title = 'Organisasi Profesi / Ilmiah';
    public string $desc = 'Keanggotaan dalam organisasi profesi atau ilmiah.';
    public string $emptyLabel = 'data organisasi profesi.';

    public function mount(int $pesertaId, string $title = 'Organisasi Profesi / Ilmiah', string $desc = 'Keanggotaan dalam organisasi profesi atau ilmiah.', string $emptyLabel = 'data organisasi profesi.', bool $enforceOwnership = true): void
    {
    ...
    public function simpanOrganisasi(?int $id, string $tahun, string $namaOrganisasi, ?string $jabatan): void
    {
        ...
        $this->simpanRiwayat(OrganisasiProfesi::class, $id, [
            'tahun' => $tahun,
    ...
    {
        $this->hapusRiwayat(OrganisasiProfesi::class, $id);
    }

    public function with(): array
    {
        return [
            'organisasi' => OrganisasiProfesi::query()
