...
new #[Layout('components.layouts.asesor')] class extends Component {
    ...
    public function with(): array
    {
        ...
        return compact('list', 'statusOptions');
    }
}; ?>

<x-slot:title>Resume Pleno</x-slot:title>
<x-slot:subtitle>Daftar resume pleno peserta RPL di prodi Anda</x-slot:subtitle>
    ...
    <div class="bg-white rounded-[10px] border border-[#E5E8EC] overflow-hidden">
        <table class="w-full">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="8" class="px-5 py-10 text-center text-[13px] text-[#8a9ba8]">Belum ada data permohonan di prodi Anda.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
